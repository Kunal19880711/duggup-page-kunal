<script lang="ts">
	...
	const links: NavLinkInfo[] = [
		...
		{
			iconSrc: 'assets/explore-icon.png',
			href: '/',
			title: 'Explore'
		},
		{
			iconSrc: 'assets/learn-icon.png',
			href: '/',
			title: 'Learn'
		}
	];
...
>
	<div class="flex flex-1 flex-row items-center gap-1 px-0">
		...
		<div class="order-1 flex-none grow-0 text-[1.75rem] text-[#333]">duggup</div>
	</div>
	<div class="flex flex-row items-center justify-between gap-5 py-2.5">
		...
		<Button variant="outline" class="border-[#4D4D4D] shadow-[0px_4px_0px_#4D4D4D]">
			<div class="flex flex-row items-center px-4">
				<i class="fa-regular fa-square-plus px-1 text-[#4D4D4D]"></i>
